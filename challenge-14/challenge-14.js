(function(){
    ...
    */
    ...
    no console.
    */
    var justMod2Or3 = justNumbers.filter(function(n) {
        return n % 2 == 0 || n % 3 == 0;
    })
    ...
    */
    var operation = justMod2Or3.reduce(function(acumulator, current){
        return (acumulator + 1) * current;
    }, 0);
    console.log( '\nOperation:' );
    ...
    console.
    */
    var operation2 = justMod2Or3.reduceRight(function(acumulator, current){
        return (acumulator + 1) * current;
    }, 0);
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = name.reduceRight(function(acum, letter) {
        return acum + letter;
    });
    ...
    */
    ...
    if(Array.isArray(justMod2Or3)) {
        console.log('Sim ;-)');
        console.log(typeof justMod2Or3);
    }
    else {
        console.log('Não :-(');
    }
