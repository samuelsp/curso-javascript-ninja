...
desafio.
*/
var teams = ['Flamengo', 'Atlético-MG', 'Botafogo', 'Bahia', 'Palmeiras'];
...
var posicoesTimes = [1, 3, 4, 2, 6];

var indiceTimes = 0;
while ( indiceTimes < posicoesTimes.length ) {
    console.log(showTeamPosition( posicoesTimes[indiceTimes] ))
    indiceTimes++;    
}
